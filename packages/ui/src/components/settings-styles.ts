...
/** A group with nothing in it yet, on the space the list would have taken: its
 * icon, what there is none of, and the way to make the first one, stacked in the
 * middle. Its contents stay with each panel — only the standing is shared. */
