...
/** The fields keep no value of their own, so a story that lets a reader choose
 * holds the one the choosing produces. */
...
export const Default = meta.story({
	parameters: {
		docs: {
			description: {
				story:
					"The nominal panel: three schemes, six palettes, three tiles a row. Check that exactly one scheme and one palette read as chosen, that the chosen palette is marked with a tick as well as an edge — selection is never colour alone — and that choosing reports the choice immediately. Pick `TwoColumns` for the narrow dialog.",
			},
		},
	},
