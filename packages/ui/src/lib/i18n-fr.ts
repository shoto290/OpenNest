...
/** The fr catalogue, one file per namespace on the same terms as the en one, and
 * mirroring it whole: a namespace or a key en holds and this one drops fails the
 * type check here. */
