...
use super::{
	drafted, git, learned, unrecorded, Author, ChangedFile, Evolution, HistoryEntry, McpServer,
	Skill, SkillDraft, SkillFront, KIROSHI_KEY, LEARNED_NAME, MANIFEST_DIR, MANIFEST_NAME,
	PRELOAD_KEY, SERVER_SUBJECT, SKILLS_DIR, SKILL_NAME, VERSION,
};
...
mod tests {
	...
	#[test]
	fn a_server_written_for_the_person_is_declared_by_the_manifest_and_reaches_the_history() {
