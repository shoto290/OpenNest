...
pub fn invoke_handler<R: Runtime>() -> impl Fn(tauri::ipc::Invoke<R>) -> bool + Send + Sync + 'static
{
	tauri::generate_handler![
		...
		environment::commands::connection_clear,
		environment::commands::connection_kind,
		...
		user::commands::user_plugin_mcp_servers,
		user::commands::user_plugin_set_mcp_server,
		user::commands::user_plugin_delete_mcp_server,
